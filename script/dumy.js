export const BOOKS = [
  ...
  },
  {
    ...
    Bagian ini membahas tentang mitos pekerja keras yang sebenarnya tidak selalu efektif.
    Bagian 2: The Power of Focus
    Bagian ini membahas tentang pentingnya fokus pada hal-hal yang penting.
    Bagian 3: The Art of Collaboration
    Bagian ini membahas tentang pentingnya kerja sama dalam bekerja.
    Bagian 4: The Power of Feedback
...
Buku Great At Work telah diterjemahkan ke dalam lebih dari 20 bahasa dan telah terjual lebih dari 1 juta kopi di seluruh dunia. Buku ini telah dipuji oleh para kritikus dan telah memenangkan banyak penghargaan, termasuk Penghargaan McKinsey untuk Buku Bisnis Terbaik.`,
  ...
  },
  {
    ...
    Bagian 1: Apa itu Stoa? Bagian ini menjelaskan sejarah dan dasar-dasar filsafat Stoa.
    Bagian 2: Praktik Stoa Bagian ini membahas tentang berbagai praktik yang dapat membantu kita menerapkan filsafat Stoa dalam kehidupan sehari-hari.
    Bagian 3: Stoa di Dunia Modern Bagian ini membahas tentang bagaimana filsafat Stoa dapat diterapkan di dunia modern.
    Buku ini ditulis dengan gaya yang menarik dan mudah dipahami. Pigliucci juga menggunakan berbagai contoh dan analogi untuk menjelaskan konsep-konsep Stoa yang abstrak.
    
    Deskripsi buku
    
    Buku How to Be a Stoic memberikan gambaran yang komprehensif tentang filsafat Stoa. Buku ini cocok untuk pembaca yang ingin mempelajari tentang filsafat Stoa untuk pertama kalinya.
    
    Berikut adalah beberapa hal yang dapat kita pelajari dari buku How to Be a Stoic:
    
    Stoa adalah filsafat yang berfokus pada pengendalian emosi dan penerimaan atas apa yang terjadi.
    Stoa mengajarkan kita untuk fokus pada hal-hal yang berada dalam kendali kita, dan untuk melepaskan hal-hal yang tidak ada dalam kendali kita.
  ...
  },
  {
    ...
    deskripsi: `Buku ini membahas tentang psikologi persuasi dan bagaimana kita dapat menggunakan prinsip-prinsip tersebut untuk mempengaruhi orang lain. Carnegie memberikan berbagai tips dan teknik yang dapat kita gunakan dalam kehidupan sehari-hari, baik dalam bisnis, hubungan pribadi, maupun situasi sosial lainnya.
      ...
      Kesamaan: Orang lebih cenderung mempercayai dan mengikuti orang yang mereka anggap mirip dengan mereka.
      Pujian: Pujian dapat membuat orang merasa baik tentang diri mereka sendiri dan lebih cenderung mendengarkan Anda.
      Ajakan bertindak: Berikan orang ajakan yang jelas dan spesifik tentang apa yang ingin Anda lakukan.
      Kebutuhan: Fokuslah pada kebutuhan orang lain dan bagaimana Anda dapat membantu mereka memenuhinya.
      Kelangkaan: Buat orang merasa bahwa sesuatu itu langka atau terbatas sehingga mereka lebih cenderung menginginkannya.
      Urgensi: Buat orang merasa bahwa mereka harus bertindak sekarang atau mereka akan kehilangan sesuatu.
      Buku Influence adalah buku yang sangat praktis dan mudah diterapkan. Teknik-teknik yang dibahas dalam buku ini dapat membantu Anda untuk lebih efektif dalam mempengaruhi orang lain.
      
      Berikut adalah beberapa contoh bagaimana Anda dapat menggunakan prinsip-prinsip persuasi dalam kehidupan sehari-hari:
      
      Dalam bisnis, Anda dapat menggunakan prinsip-prinsip persuasi untuk meyakinkan pelanggan untuk membeli produk atau layanan Anda.
  ...
  },
  {
    ...
    deskripsi: `Buku ini membahas tentang filosofi investasi value investing, yang menekankan pada analisis fundamental dan pembelian saham yang undervalued. Graham berpendapat bahwa investor yang sukses harus fokus pada jangka panjang dan menghindari spekulasi.
      ...
      Bagian pertama membahas tentang filosofi investasi value investing dan prinsip-prinsip dasar yang harus diikuti oleh investor.
      Bagian kedua membahas tentang berbagai teknik analisis fundamental yang dapat digunakan untuk menilai saham.
      The Intelligent Investor adalah buku yang sangat penting bagi siapa saja yang ingin berinvestasi secara sukses. Buku ini memberikan dasar yang kuat untuk memahami filosofi value investing dan menerapkannya dalam praktik.
      
      Berikut adalah beberapa poin penting yang dibahas dalam buku The Intelligent Investor:
      
      Investasi adalah bisnis, bukan perjudian. Investor harus fokus pada jangka panjang dan menghindari spekulasi.
      Investor harus fokus pada nilai, bukan harga. Harga adalah apa yang Anda bayar, sedangkan nilai adalah apa yang Anda dapatkan.
  ...
  },
  {
    ...
    deskripsi: `
      ...
      Ruby memulai buku ini dengan menceritakan tentang pengalamannya sendiri dalam mencari jati diri. Ia merasa bingung dan tidak yakin tentang apa yang ingin ia lakukan dengan hidupnya. Ia mencoba berbagai hal, tetapi tidak ada yang membuatnya merasa puas.
      
      Setelah melalui berbagai eksperimen, Ruby akhirnya menemukan apa yang ia inginkan. Ia menyadari bahwa yang terpenting adalah untuk menjadi diri sendiri dan menjalani kehidupan yang sesuai dengan nilai-nilai yang ia yakini.
      
      Buku ini dibagi menjadi tiga bagian utama, yaitu:
      
      Part 1: The Search for Identity
      Pada bagian ini, Ruby membahas tentang pentingnya menemukan diri sendiri. Ia memberikan berbagai tips dan teknik untuk membantu kita menemukan jati diri kita.
      
      Part 2: The Power of Experiments
      Pada bagian ini, Ruby membahas tentang pentingnya melakukan eksperimen dalam hidup. Ia percaya bahwa eksperimen adalah cara terbaik untuk menemukan apa yang kita inginkan.
      
      Part 3: The Importance of Self-Awareness
      Pada bagian ini, Ruby membahas tentang pentingnya menjadi sadar diri. Ia percaya bahwa kesadaran diri adalah kunci untuk menjalani kehidupan yang bermakna.
      
      Buku You Do You adalah buku yang sangat inspiratif dan bermanfaat. Buku ini dapat membantu kita untuk menemukan diri sendiri dan menjalani kehidupan yang lebih bermakna.
      
      Berikut adalah beberapa poin penting yang dibahas dalam buku You Do You:
      
      Kita harus berhenti mengejar ekspektasi orang lain dan mulai fokus pada apa yang kita inginkan untuk diri kita sendiri.
